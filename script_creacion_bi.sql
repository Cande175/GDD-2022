...
NEUMATICO_ TIPO not null REFERENCES LOCRO.BI_TIPO_NEUMATICO(TIPO_NEUMATICO_ID)
);
...
TELE_NEUMATICO_NEUMATICO INT not null REFERENCES LOCRO.BI_NEUMATICO(NEUMATICO_NRO_SERIE),
TELE_NEUMATICO_TELE_AUTO INT not null REFERENCES LOCRO.BI_TELE_AUTO(TELE_AUTO_ID),
TELE_NEUMATICO_PROFUNDIDAD INT not null,
...
TELE_MOTOR_POTENCIA int not null,
...
IF EXISTS(SELECT [name] FROM sys.procedures WHERE [name] = 'MIGRAR_BI_TIPO_NEUMATICO')
DROP PROCEDURE MIGRAR_BI_TIPO_NEUMATICO
GO
...
IF EXISTS(SELECT [name] FROM sys.procedures WHERE [name] = 'MIGRAR_BI_NEUMATICO')
DROP PROCEDURE MIGRAR_BI_NEUMATICO
GO
...
IF EXISTS(SELECT [name] FROM sys.procedures WHERE [name] = 'MIGRAR_BI_TELE_NEUMATICO')
DROP PROCEDURE MIGRAR_BI_TELE_NEUMATICO
GO
...
BEGIN
	...
	SELECT TELE_NEUMATICO_NUMERO, TELE_AUTO_NRO_VUELTA, TELE_NEUMATICO_NEUMATICO, TELE_NEUMATICO_TELE_AUTO, TELE_NEUMATICO_PROFUNDIDAD, SECTOR_CIRCUITO
	FROM LOCRO.TELE_NEUMATICO
	JOIN LOCRO.TELE_AUTO ON TELE_AUTO_ID = TELE_NEUMATICO_TELE_AUTO
	JOIN LOCRO.SECTOR ON TELE_AUTO_SECTOR = SECTOR_ID
	PRINT('TELE_NEUMATICO MIGRADO!!')
END
GO

IF EXISTS(SELECT [name] FROM sys.procedures WHERE [name] = 'MIGRAR_BI_CAJA')
DROP PROCEDURE MIGRAR_BI_CAJA
GO
...
IF EXISTS(SELECT [name] FROM sys.procedures WHERE [name] = 'MIGRAR_BI_TELE_CAJA')
DROP PROCEDURE MIGRAR_BI_TELE_CAJA
GO
...
BEGIN
	...
	SELECT TELE_CAJA_NUMERO, TELE_CAJA_CAJA, TELE_CAJA_DESGASTE, TELE_CAJA_TELE_AUTO, TELE_AUTO_NRO_VUELTA, SECTOR_CIRCUITO
	FROM LOCRO.TELE_NEUMATICO
	JOIN LOCRO.TELE_AUTO ON TELE_AUTO_ID = TELE_CAJA_TELE_AUTO
	JOIN LOCRO.SECTOR ON TELE_AUTO_SECTOR = SECTOR_ID
	PRINT('TELE_CAJA MIGRADA!!')
END
GO

IF EXISTS(SELECT [name] FROM sys.procedures WHERE [name] = 'MIGRAR_BI_FRENO')
DROP PROCEDURE MIGRAR_BI_FRENO
GO
...
IF EXISTS(SELECT [name] FROM sys.procedures WHERE [name] = 'MIGRAR_BI_TELE_FRENO')
DROP PROCEDURE MIGRAR_BI_TELE_FRENO
GO
...
BEGIN
	...
	SELECT TELE
	FROM LOCRO.TELE_FRENO_NUMERO, TELE_FRENO_TELE_AUTO, TELE_FRENO_FRENO, TELE_FRENO_GROSOR, TELE_AUTO_NRO_VUELTA, SECTOR_CIRCUITO
	JOIN LOCRO.TELE_AUTO ON TELE_AUTO_ID = TELE_FRENO_TELE_AUTO
	JOIN LOCRO.SECTOR ON TELE_AUTO_SECTOR = SECTOR_ID
	PRINT('TELE_FRENO MIGRADA!!')
END
GO

IF EXISTS(SELECT [name] FROM sys.procedures WHERE [name] = 'MIGRAR_BI_MOTOR')
DROP PROCEDURE MIGRAR_BI_MOTOR
GO
...
IF EXISTS(SELECT [name] FROM sys.procedures WHERE [name] = 'MIGRAR_BI_TELE_MOTOR')
DROP PROCEDURE MIGRAR_BI_TELE_MOTOR
GO
...
BEGIN
	...
	INSERT INTO LOCRO.BI_CAJA
	SELECT TELE_MOTOR_NUMERO, TELE_MOTOR_TELE_AUTO, TELE_MOTOR_MOTOR, TELE_MOTOR_POTENCIA, TELE_AUTO_NRO_VUELTA, SECTOR_CIRCUITO
	FROM LOCRO.TELE_MOTOR
	JOIN LOCRO.TELE_AUTO ON TELE_AUTO_ID = TELE_MOTOR_TELE_AUTO
	JOIN LOCRO.SECTOR ON TELE_AUTO_SECTOR = SECTOR_ID

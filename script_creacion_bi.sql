...
AS
	...
	AVG((SELECT COUNT(*)
		FROM LOCRO.BI_INCIDENTES_ESCUDERIA_CIRCUITO i
		WHERE i.ESCUDERIA_ID = ESCUDERIA_ID AND i.TIPO_SECTOR_ID = TIPO_SECTOR_ID
		GROUP BY ESCUDERIA_ID, TIPO_SECTOR_ID, ANIO)) AS 'CANTIDAD'
